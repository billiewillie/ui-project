...
export default function TogglePage1() {
	const htmlCode = `
  <div class="toggleWrapper">
      <input type='checkbox' id='toggleInput1' />
      <label for='toggleInput1' class="toggle">
        <span class="toggleHandler">
            <span class="crater crater1"></span>
